...
class Controller {
    ...
    private $wrapLayout = 'main::includes/layout';
    ...
    public function render($content, $wrap = false, $miniLayout=false) {
        ...
        if($miniLayout)
        {
            $this->mainLayout = "main::includes/mini_layout";
        }
    ...
    public function loadModel($model) {
        ...
        $model = str_replace('-', '',ucwords($model)).'Model';
